...
par(mfrow = c(2,2))
plot(hpc_data_set$Date_Time, hpc_data_set$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")

plot(hpc_data_set$Date_Time, hpc_data_set$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")

plot(hpc_data_set$Date_Time, hpc_data_set$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "")
points(hpc_data_set$Date_Time, hpc_data_set$Sub_metering_2, type = "l", col = "red")
...
plot(hpc_data_set$Date_Time, hpc_data_set$Global_reactive_power,
